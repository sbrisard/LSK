...
\begin{equation}
  ...
  λ] .
\end{equation}
Noter que $ℰ₂$, $ℰ₃$ et $ℰ_4$ sont des formes
...
$ℰ₃$ et $ℰ_4$ sont implicitement évaluées en
...
\begin{equation}
  ...
  +ℰ₃ (v, v, w) + \tfrac{1}{12} ℰ_4 (v, v, v, v) \right]
  + o (ξ^4)
\end{equation}
...
base $v_i$
\begin{equation} ℰ₃ (λ₀ ; v_j, v_k, \hat{u}) ξ₁^k \chi₀^j
   +ℰ₂ (λ₀ ; x₁, \hat{u}) + λ₁  \dot{ℰ₂}
...
\begin{equation} ℰ₃ (λ₀ ; v_j, v_k, \hat{w}) ξ₁^k \chi₀^j
   +ℰ₂ (λ₀ ; y₁, \hat{w}) + λ₁  \dot{ℰ₂}
...
\begin{equation} ℰ_4 (λ₀ ; v_i, v_j, v_k, v_l) +ℰ₃ (λ₀ ;

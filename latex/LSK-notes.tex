...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
where dotted quantities refer to derivatives with respect to \(\lambda\).
...
\begin{equation}
  u_0 = u^\ast(\lambda_0), \quad
  \dot{u}_0 = \dot{u}^\ast(\lambda_0), \quad
  \ddot{u}_0 = \ddot{u}^\ast(\lambda_0), \quad
  \dddot{u}_0 = \dddot{u}^\ast(\lambda_0), \quad
  \ddddot{u}_0 = \ddddot{u}^\ast(\lambda_0)
\end{equation}
and
\begin{equation}
...
Note that \(\E_2\), \(\E_3\) and \(E_4\) thus defined are bi-, tri- and quadrilinear forms, respectively. Evaluation of
these forms over $U$ will be denoted \(\E_2(u, v)\), \(\E_3(u, v, w)\), etc. The following derivatives are also
introduced
\begin{equation}

...
\begin{equation}
  \begin{aligned}[b]
    ...
    & + ℰ_{, uu}[u^{\ast}(λ) + U(η), λ; U'''(η), \hat{u}],
  \end{aligned}
\end{equation} \pdfmargincomment{Relecture 31/05/2022 08:11}
soit, en \(η = 0\)
\begin{equation}
...
\subsection{Développement limité de l'énergie} \pdfmargincomment{Relecture 31/05/2022 09:10}
\label{sec:DLenergie}
...
\begin{equation} \frac{∂^k F}{∂ λ^k}(0, λ) = 0 \quad(k \geq 0),
\end{equation}
tandis que les dérivées de \(F\) par rapport à \(η\) s'écrivent
\begin{equation} ∂_{η} F(η, λ) =ℰ_{, u} [u^{\ast}(λ) +
  U(η), λ; U'(η)], \end{equation}
\begin{equation} ∂_{η η}^2 F(η, λ) =ℰ_{, u
...
λ] = 0\)
\begin{equation} ∂_{η} F(0, λ) = 0, \end{equation}
\begin{equation} ∂_{η η}^2 F(0, λ) =ℰ₂(λ ;
  u₁, u₁), \end{equation}
\begin{equation} ∂_{η η η}^3 F(0, λ) =ℰ₃
...
\end{eqnarray}
On en déduit que
\begin{equation} ∂_{η λ}^2 F(0, λ) = 0, \end{equation}
\begin{equation} ∂_{η η λ}^3 F(0, λ) =
  \dot{ℰ}₂(λ; u₁, u₁), \end{equation}
\begin{equation} ∂_{η λ λ}^3 F(0, λ) = 0, \end{equation}
\begin{equation} ∂_{η η η λ}^4 F(0,
  λ) = \dot{ℰ}₃(λ; u₁, u₁, u₁) + 3
  \dot{ℰ}₂(λ; u₁, u₂), \text{} \text{} \end{equation}
\begin{equation} ∂_{η η λ λ}^4 F(0,
  λ) = \ddot{ℰ}₂(λ; u₁, u₁), \end{equation}
\begin{equation} ∂_{η λ λ λ}^4 F(0,
  λ) = 0 \end{equation}
et finalement

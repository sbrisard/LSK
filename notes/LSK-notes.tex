...
le produit scalaire $〈 \bullet, \bullet \rangle$ (qui n'est pas
...
\begin{equation}
  ...
  α 〈 x, \hat{u} \rangle \quad \text{pour tout} \quad \hat{u} \in
  V.
\end{equation}
...
et
\begin{eqnarray*}
  α 〈 x, \hat{u} \rangle & = & α₀  〈 x₀, \hat{u}
  \rangle + η (α₁ 〈 x₀, \hat{u} \rangle + α₀ 〈
  x₁, \hat{u} \rangle)\\
  &  & + \tfrac{1}{2} η^2  (α₂ 〈 x₀, \hat{u} \rangle + 2
  α₁ 〈 x₁, \hat{u} \rangle + α₀ 〈 x₂, \hat{u}
  \rangle) + o (η^2) .
\end{eqnarray*}

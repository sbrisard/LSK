...
produit scalaire \(\langle•,•\rangle\) (qui n'est pas précisé pour
...
\begin{equation}
  \begin{aligned}[b]
    \Delta\mathcal E ={}&
    \mathcal E(u₀+ξ v+\eta w)-\mathcal E(u₀)\\
    ={}&\tfrac12\mathcal E_{,uu}(u₀;ξ v+\eta w, ξ v+\eta w)
    +\tfrac16\mathcal E_{,uuu}(u₀;ξ v+\eta w, ξ v+\eta w, ξ v+\eta w)\\
    &+\tfrac1{24}\mathcal E_{,uuuu}(u₀;ξ v+\eta w, ξ v+\eta w, ξ v+\eta w,
...
\(\mathcal E_{,uu}(v, •)=0\), l'expression précédente s'écrit
\begin{equation}
  \begin{aligned}[b]
    \Delta\mathcal E
    ={}&\tfrac12\eta^2\mathcal E_{,uu}(w, w)
    +\tfrac16ξ^3\mathcal E_{,uuu}(v, v, v)
    +\tfrac12ξ^2\eta\mathcal E_{,uuu}(v, v, w)\\
    &+\tfrac12ξ\eta^2\mathcal E_{,uuu}(v, w, w)
    +\tfrac16\eta^3\mathcal E_{,uuu}(w, w, w)\\
    &+\tfrac1{24}ξ^4\mathcal E_{,uuuu}(v, v, v, v)
    +\tfrac16ξ^3\mathcal E_{,uuuu}(v, v, v, w)\\
    &+\tfrac14ξ^2\eta^2\mathcal E_{,uuuu}(v, v, w, w)
    +\tfrac16ξ\eta^3\mathcal E_{,uuuu}(v, w, w, w)\\
...
\begin{equation}
  \Delta\mathcal E
  =\tfrac12ξ^4\bigl[\mathcal E_{,uu}(w, w)+\mathcal E_{,uuu}(v, v, w)
  +\tfrac1{12}\mathcal E_{,uuuu}(v, v, v, v)\bigr]+o(ξ^4)
\end{equation}

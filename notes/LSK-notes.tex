...
\eqref{eq:20220524134121} et \eqref{eq:20220524134835} pour obtenir les formes
...
bifurcation \eqref{eq:20220524134835} est alors simplement~: \(E_{ijkl}(λ₀)\).
...
bifurcation \eqref{eq:20220524134835} est alors simplement~:
\(3 λ₁ \dot{E}_{ijk}(λ₀)\).
...
\paragraph{Synthèse~: simplification des équations \eqref{eq:20220524133816} et
  \eqref{eq:20220524134835}} En rassemblant les résultats précédents, on obtient
tout d'abord pour l'équation \eqref{eq:20220524134835}
\begin{equation}

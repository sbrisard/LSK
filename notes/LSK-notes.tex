...
\subsection{Asymmetric bifurcated branch (\(λ₁ ≠ 0\))\pdfmargincomment{Discuss energy of the system and number of solutions}}
...
\subsection{A particular case of symmetric bifurcation \pdfmargincomment{Discuss energy of the system}}

...
\begin{equation}
  ℰ₁₁₁₁(λ₀)+6λ₂\dot{ℰ}₁₁(λ₀)=0,
  \quad\text{soit}\quad
  λ₂=-\frac{ℰ₁₁₁₁(λ₀)}{6\dot{ℰ}₁₁(λ₀)},
\end{equation}
et on supposera cette fois-ci que \(ℰ₁₁₁₁≠0\). Le développement
asymptotique~\eqref{eq:20211115082025} de la Hessienne s'écrit alors
\begin{equation}
  \begin{aligned}[b]
    ℰ_{,uu}[u(η), λ(η); v₁, v₁]
    ={}&\tfrac12η²\bigl[ℰ₁₁₁₁(λ₀)+λ₂\dot{ℰ}₁₁(λ₀)\\
    &+ℰ₃(λ₀; v₁, v₁, u₂)\bigr]+o(η²).
  \end{aligned}
\end{equation}
...
\begin{equation}
  \begin{aligned}[b]
    ℰ_{,uu}[u(η), λ(η); v₁, v₁]
    ={}&+\tfrac12η²\bigl[\tfrac 56ℰ₁₁₁₁(λ₀)-2ℰ₂(λ₀;w₁₁, w₁₁)\bigr]
    +o(η²).
  \end{aligned}
\end{equation}

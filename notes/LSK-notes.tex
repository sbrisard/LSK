...
que\pdfmargincomment{À compléter}
\begin{align}
...
\begin{equation}
  ...
  f'(η)=∂_η F[η, λ₀+λ(η)]+λ'(η)\,∂_λ F[η, λ₀+λ(η)],
\end{equation}
\begin{equation}
  \begin{aligned}[b]
    \label{eq:20211112165810}
    f''(η)={}&∂_{ηη}²F[η, λ₀+λ(η)]+2λ'(η)\,∂_{ηλ}²F[η, λ₀+λ(η)]\\
    &+λ''(η)\,∂_λ F[η, λ₀+λ(η)]+λ'(η)²∂_{λλ}²F[η, λ₀+λ(η)]
  \end{aligned}
\end{equation}
et
\begin{equation}
  ...
  \begin{aligned}[b]
    f'''(η)={}&∂_{ηηη}³F[η, λ₀+λ(η)]\\
    &+3λ'(η)\,∂_{ηηλ}³F[η, λ₀+λ(η)]\\
    &+3λ'(η)²∂_{ηλλ}³F[η, λ₀+λ(η)]\\
    &+3λ''(η)\,∂_{ηλ}²F[η, λ₀+λ(η)]\\
    &+λ'''(η)\,∂_λ F[η, λ₀+λ(η)]\\
    &+3λ'(η)\,λ''(η)\,∂_{λλ}²F[η, λ₀+λ(η)]\\
    &+λ'(η)³∂_{λλλ}³F[η, λ₀+λ(η)].
  \end{aligned}
\end{equation}
...
Par ailleurs, \(∂_{ηλ}²F(0, λ)\) s'obtient par simple dérivation de la
relation~\eqref{eq:20211112165323}
\begin{equation}
  \label{eq:20211112165843}
  ∂_{ηλ}²F(0, λ)=\dot{ℋ}(u₁, \hat{u}).
\end{equation}
...
\begin{equation}
  ...
  f''(0)=𝒯(u₁, u₁, \hat{u})+2λ₁\dot{ℋ}(u₁, \hat{u})+2ℋ(u₂, \hat{u}).
\end{equation}
...
dérivation par rapport à \(λ\) des expressions~\eqref{eq:20211112165830} et
\eqref{eq:20211112165843}, on trouve par ailleurs
\begin{equation}
  \label{eq:20211112173247}
  ∂_{ηηλ}³F(0, λ)=\dot{𝒯}(u₁, u₁, \hat{u})+2\dot{ℋ}(u₂, \hat{u})
  \quad\text{et}\quad
  ∂_{ηλλ}³F(0, λ)=\ddot{ℋ}(u₁, \hat{u}).
\end{equation}
...
\begin{equation}
  ...
  ∂_{ηηη}³F(0, λ)=𝒬(u₁, u₁, u₁, \hat{u})+6𝒯(u₁, u₂, \hat{u})+6ℋ(u₃, \hat{u}).
\end{equation}
...
\label{eq:20211112182402}
  \begin{aligned}[b]
    f'''(0)={}&𝒬(u₁, u₁, u₁, \hat{u})+6𝒯(u₁, u₂, \hat{u})+6ℋ(u₃, \hat{u})\\
    &+3λ₁\bigl[\dot{𝒯}(u₁, u₁, \hat{u})+2\dot{ℋ}(u₂, \hat{u})\bigr]
    +3λ₁²\ddot{ℋ}(u₁, \hat{u})\\
    &+6λ₂\dot{ℋ}(u₁, \hat{u}).
  \end{aligned}

...
On observe tout d'abord que \(F(0, λ)=ℋ(λ; \hat{u}, \hat{v})\), soit, en
dérivant par rapport à \(λ\)
\begin{equation}
  ∂_λ F(0, λ)=\dot{ℋ}(\hat{u}, \hat{v})
  \quad\text{et}\quad
  ∂_{λλ}²F(0, λ)=\ddot{ℋ}(\hat{u}, \hat{v}).
\end{equation}

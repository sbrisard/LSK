...
\begin{equation}
  \begin{aligned}[b]
    ...
    + \E_{,uuu}(u_0, \lambda_0; w_{ij} + \epsilon_{,ij} \, w_{,\epsilon},  v_k, \hat{v}) &\\
    + \E_{,uuu}(u_0, \lambda_0; w_{ik} + \epsilon_{,ik} \,  w_{,\epsilon}, v_j, \hat{v}) &\\
    + \E_{,uuu}(u_0, \lambda_0; v_i, w_{jk} + \epsilon_{,jk} \,  w_{,\epsilon}, \hat{v}) &= 0
  \end{aligned}
\end{equation}

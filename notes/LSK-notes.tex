...
s'obtient par simple combinaison linéaire des \(w_i\) et \(w_{ij}\) [defined by
the variational problems~\eqref{eq:20220524134525} and
...
\pdfmargincomment{Je ne suis pas sûr du terme faisant intervenir Ȧᵢⱼ(λ₀)}
\begin{equation}

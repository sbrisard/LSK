...
En utilisant les relations~\eqref{eq:20211112182917}, \eqref{eq:20211112183220}
et \eqref{eq:20220114135717} l'expression précédente se simplifie
\begin{equation}
  \begin{aligned}[b]
    ℰ[u(η), λ(η)]={}&ℰ\bigl(u^*[λ(η)], λ(η)\bigr)-\tfrac1{12}η³ℰ₃(λ₀;u₁, u₁, u₁)\\
    &-\tfrac1{24}η⁴\bigl\{ℰ₄(λ₀;u₁, u₁, u₁, u₁)-12ℰ₂(λ₀; u₂, u₂)\\
    &+2λ₁\bigl[\dot{ℰ}₃(λ₀; u₁, u₁, u₁)-6\dot{ℰ}₂(λ₀; u₁, u₂)\bigr]\bigr\}+o(η⁴).
  \end{aligned}
\end{equation}

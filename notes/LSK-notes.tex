...
\end{equation}
soit finalement
\begin{equation} λ_2 = - \frac{\mathcal{E}_{1  1  1  1}
   (λ_0) - 12\mathcal{E}_2 (λ_0 ; w_{11}, w_{11})}{6
   \dot{\mathcal{E}}_{1  1} (λ_0)}, \end{equation}
...
fondamentale, soit
\begin{equation} F (\eta, λ) =\mathcal{E} [u^{\ast} (λ) + U (\eta), λ]
   -\mathcal{E} [u^{\ast} (λ), λ] \end{equation}
et
...
\begin{equation} \partial_{\eta} F (\eta, λ) =\mathcal{E}_{, u} [u^{\ast} (λ) +
   U (\eta), λ ; U' (\eta)], \end{equation}
\begin{equation} \partial_{\eta  \eta}^2 F (\eta, λ) =\mathcal{E}_{, u
...
λ_0 + λ (\eta)]$, avec
\begin{equation} F (\eta, λ) =\mathcal{E}_{, u  u} [u^{\ast} (λ) + U
...
\begin{equation} \partial_{λ} F (0, λ) = \dot{\mathcal{E}_2} (λ ; \hat{u},
   \hat{v}) \quad \text{et} \quad \partial_{λ  λ}^2 F (0,
   λ) = \ddot{\mathcal{E}_2} (λ ; \hat{u}, \hat{v}) . \end{equation}
On trouve de même successivement
\begin{equation} \partial_{\eta} F (\eta, λ) =\mathcal{E}_{, u  u  u}
...
\end{eqnarray}
soit, en $\eta = 0$
\begin{equation} \partial_{\eta} F (0, λ) =\mathcal{E}_3 (λ ; u_1, \hat{u},
   \hat{v}) \text{} \end{equation}
et
\begin{equation} \partial_{\eta  \eta}^2 F (0, λ) =\mathcal{E}_4 (λ ;
   u_1, u_1, \hat{u}, \hat{v}) +\mathcal{E}_3 (λ ; u_2, \hat{u},
   \hat{v}), \end{equation}
et en dérivant cette fois par rapport à $λ$
\begin{equation} \partial_{\eta  λ}^2 F (0, λ) = \dot{\mathcal{E}_3}
...
\begin{equation} f' (0) =\mathcal{E}_3 (λ_0 ; u_1, \hat{u}, \hat{v}) + λ_1
   \dot{\mathcal{E}_2} (λ_0 ; \hat{u}, \hat{v}), \end{equation}
\begin{eqnarray}
...
\begin{equation} \mathcal{E}_2 (λ_0 ; x_0, \hat{u}) = \alpha_0  \langle x_0, \hat{u}
   \rangle . \end{equation}
...
\begin{equation} \mathcal{E}_3 (λ_0 ; u_1, x_0, \hat{u}) +\mathcal{E}_2 (λ_0 ;
...
base $v_i$
\begin{equation} \mathcal{E}_3 (λ_0 ; v_j, v_k, \hat{u}) \xi_1^k \chi_0^j
...
\begin{equation} [\mathcal{E}_3 (λ_0 ; v_i, v_j, v_k) \xi_1^k + λ_1
...
\begin{equation} \mathcal{E}_3 (λ_0 ; v_j, v_k, \hat{w}) \xi_1^k \chi_0^j
...
\begin{equation} \mathcal{E}_2 (λ_0 ; x_2, \hat{u}) + 2\mathcal{E}_3 (λ_0 ; u_1,
...
\begin{equation} \mathcal{E}_4  (λ_0 ; v_i, v_j, v_k, v_l) \chi_0^j \xi_{1 }^k \xi_1^l
...
\begin{equation} \mathcal{E}_3 (λ_0 ; v_i, v_j, w_{k  l}) \xi_1^j \xi_1^k
...
\begin{equation} \mathcal{E}_4 (λ_0 ; v_i, v_j, v_k, v_l) +\mathcal{E}_3 (λ_0 ;
   v_i, v_j, w_{k  l}) +\mathcal{E}_3 (λ_0 ; v_i, v_k, w_{j
    l}) +\mathcal{E}_3 (λ_0 ; v_i, v_l, w_{j  k}), \end{equation}
...
\begin{equation} \mathcal{E}_3 (λ_0 ; v_i, v_j, w_k) \xi_1^j \xi_1^k = \tfrac{1}{2}
...
\begin{equation} \mathcal{E}_3 (λ_0 ; v_i, v_j, w_k) = -\mathcal{E}_2 (λ_0 ;
   w_{i  j}, w_k), \end{equation}
puis, en prenant cette fois $\hat{w} = w_{i  j}$ dans le problème
variationnel \eqref{eq:pbvar wi}
\begin{equation} \mathcal{E}_2 (λ_0 ; w_k, w_{i  j}) = - 2 \dot{\mathcal{E}_2}
   (λ_0 ; v_k, w_{i  j}), \end{equation}
soit finalement
\begin{equation} \mathcal{E}_3 (λ_0 ; v_i, v_j, w_k) \xi_1^j \xi_1^k =
...
l'équation de bifurcation \eqref{eq:bifurcation 2a}
\begin{equation} 3 λ_1  [\dot{\mathcal{E}}_3 (λ_0 ; v_i, v_j, v_k) +
   \dot{\mathcal{E}_2} (λ_0 ; v_i, w_{j  k}) +
   \dot{\mathcal{E}}_2 (λ_0 ; v_j, w_{i  k}) +
   \dot{\mathcal{E}}_2 (λ_0 ; v_k, w_{i  j})], \end{equation}
...
\begin{equation} \dot{\mathcal{E}_2} (λ_0 ; v_i, w_j) = - \tfrac{1}{2} \mathcal{E}_2
   (λ_0 ; w_i, w_j) = - \tfrac{1}{2} \mathcal{E}_2 (λ_0 ; w_j,
   w_i) = \dot{\mathcal{E}_2} (λ_0 ; v_j, w_i) . \end{equation}
On obtient donc l'expression suivante du terme linéaire en $\xi_1^i$ dans
l'équation de bifurcation \eqref{eq:bifurcation 2a}
\begin{equation} \ddot{\mathcal{E}}_2 (λ_0 ; v_i, v_j) + \tfrac{1}{2}

...
\end{equation}
Soit $w_{i \nocomma j} \in W$ l'unique solution du problème variationnel
suivant
\begin{equation}
...
matrice symétrique $[E_{i \nocomma j \nocomma k} (\lambda_0) \xi_1^k +
\lambda_1 F_{i \nocomma j} (\lambda_0)]$ associé à la valeur propre
...
\nocomma j}$ et $w_i$ définis respectivement par les problèmes
...
qui suggère d'introduire le \ $E_{i \nocomma j \nocomma k \nocomma l}
...
\[ 3 \lambda_1  [\dot{\mathcal{E}}_3 (\lambda_0 ; v_i, v_j, v_k) +
   ...
   \dot{\mathcal{E}}_2 (\lambda_0 ; v_j, w_{i \nocomma k}) +
   \dot{\mathcal{E}}_2 (\lambda_0 ; v_k, w_{i \nocomma j})], \]
qui suggère d'introduire le tenseur $E_{i \nocomma j \nocomma k}

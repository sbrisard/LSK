...
\begin{equation}
  \begin{aligned}[b]
    ...
    + \epsilon_{,i\lambda} \, \EE_{,uu\epsilon}(u_0, \lambda_0, 0; \dot{u}_0, \hat{v})
    + \epsilon_{,i\lambda} \, \EE_{,u\lambda\epsilon}(u_0, \lambda_0, 0; \hat{v}) &\\
    %
    + \epsilon_{,i\lambda} \, \EE_{,uu\epsilon}(u_0, \lambda_0, 0; \dot{u}_0, \hat{v})
    %
    + \epsilon_{,i\lambda} \, \EE_{,u\lambda\epsilon}(u_0, \lambda_0, 0; \hat{v}) &= 0
  \end{aligned}
\end{equation}

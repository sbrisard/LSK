...
can be evaluated at $\xi_1 = \cdots = \xi_m = 0$ and \(\epsilon = 0\). In this paragraph, $\hat{v}$ denotes an arbitrary element of
$V$.

\paragraph{Differentiation of Eq.~\eqref{eq:20220901120544} with respect to \(\xi_i\)}
\begin{equation}
...
\paragraph{Differentiation of Eq.~\eqref{eq:20220901120544} with respect to \(\epsilon\)}
\begin{equation}
  \begin{aligned}[b]
...
\begin{equation}
  \E_2(\lambda_0; w_{,\epsilon}, \hat{v}) + \lambda_{,\epsilon} \, \dot{\E}_1(\lambda_0; \hat{v}) + \EE_{,u\epsilon}(u_0, \lambda_0, 0; \hat{v}) = 0.
\end{equation}

In the above equation, the first term vanishes since \(\hat{v} \in V = \ker \E_2(\lambda_0)\), while the second term also
vanishes because \(\E_1(\lambda; \hat{v}) = 0\) for all \(\lambda\). We therefore get
\begin{equation}
  \EE_{,u\epsilon}(u_0, \lambda_0, 0; \hat{v}) = 0.
\end{equation}

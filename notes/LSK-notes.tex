...
In this section, $\mathcal T$ denotes a trilinear, symmetric form over the vector space
$U$.
...
\end{theorem}
\begin{proof}
  The form $\mathcal T$ being trilinear and symmetric, we have, for all $u, v, w \in U$
  and $\alpha, β \in \reals$
  \begin{multline*}
    \mathcal T(u + \alpha v + βw, u + \alpha v + βw, u + \alpha v + βw) = \mathcal T(u, u, u) + 3\alpha \mathcal T(u, u, v)\\
    + 3β \mathcal T(u, u, w) + 3\alpha^2 \mathcal T(u, u, v) + 6 \alpha β \mathcal T(u, v, w) + 3 β^2 \mathcal T(u, u, w)\\
    + \alpha^3 \mathcal T(v, v, v) + 3 \alpha^2 β \mathcal T(v, v, w) + 3 \alpha β^2 \mathcal T(v, w, w) + β^3 \mathcal T(w, w, w)
  \end{multline*}
  and, upon simplification using Eq.~\eqref{eq:20220802111745}
  \begin{multline}
    \label{eq:20220802112309}
    3\alpha \mathcal T(u, u, v) + 3β \mathcal T(u, u, w) + 3\alpha^2 \mathcal T(u, v, v) + 6 \alpha β \mathcal T(u, v, w)\\
    + 3 β^2 \mathcal T(u, w, w) + 3 \alpha^2 β \mathcal T(v, v, w) + 3 \alpha β^2 \mathcal T(v, w, w) = 0.
  \end{multline}
  ...
  \end{equation*}
  from which it results that $\mathcal T(u, u, v) = 0$ for all $u, v \in U$. Plugging

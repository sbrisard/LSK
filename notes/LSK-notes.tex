...
\begin{equation}
  ...
  ∂_{ηη}²F(0, λ)=𝒯(u₁, u₁, \hat{u})
  +2ℋ(u₂, \hat{u}).
\end{equation}

Par ailleurs, \(∂_{ηλ}²F(0, λ)\) s'obtient par simple
...
En posant \(u₁=ξᵢaᵢ\) et \(v₀=χ ⱼ aⱼ\), on obtient l'équation
\begin{equation}
  \bigl(𝒯_{ijk}^*ξₖ+λ₁\dot{ℋ}_{ij}^*\bigr)χ ⱼ
  =α₁χ ᵢ,
\end{equation}

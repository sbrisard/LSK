...
branche bifurquée est \emph{instable} pour $λ < λ₀$ et
\emph{stable} pour $λ > λ₀$ lorsque $ℰ_{1  1
 1} (λ₀) \neq 0$.
...
Ainsi, le vecteur $χ₀^i$ apparaît comme le vecteur propre de la
...
déterminer les $χ₀^i$. On prend maintenant $\hat{u} = \hat{w}∈W$
dans le problème variationnel d'ordre 1, et on pose $x₁ = χ₁^i v_i +

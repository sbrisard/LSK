...
\begin{equation}
  ...
  \nocomma j}, w_{k \nocomma l}) \right] \xi^i \xi^j \xi^k \xi^l \geq 0,
\end{equation}
...
s'{\'e}crit
\begin{equation}
  \label{eq20220216140121} \mathcal{E}_{i \nocomma j \nocomma k} (\lambda_0) 
...
\begin{equation}
  \label{eq20220124135324} u_2^W = \xi_1^i \xi_1^j w_{i \nocomma j} +
...
\begin{eqnarray}
  6 \xi_2^j  [\xi_1^k \mathcal{E}_{i \nocomma j \nocomma k} (\lambda_0) +
  \lambda_1  \dot{\mathcal{E}}_{i \nocomma j} (\lambda_0)] &  &  \nonumber\\
  + \xi_1^j \xi_1^k \xi_1^l  [\mathcal{E}_{i \nocomma j \nocomma k \nocomma l}
  (\lambda_0) + 6\mathcal{E}_3 (\lambda_0 ; v_i, v_j, w_{k \nocomma l})] &  & 
  \nonumber\\
  + 3 \lambda_1 \xi_1^j \xi_1^k  [\dot{\mathcal{E}}_{i \nocomma j \nocomma k}
  (\lambda_0) + 2\mathcal{E}_3 (\lambda_0 ; v_i, v_j, w_k) + 2
  \dot{\mathcal{E}_2} (\lambda_0 ; v_i, w_{j \nocomma k})] &  &  \nonumber\\
  + 3 \lambda_1^2 \xi_1^j  [\ddot{\mathcal{E}}_{i \nocomma j} (\lambda_0) + 2
  \dot{\mathcal{E}_2} (v_i, w_j)] + 6 \lambda_2 \xi_1^j  \dot{\mathcal{E}}_{i
  \nocomma j} (\lambda_0) & = & 0.  \label{eq20220210143805}
\end{eqnarray}
...
\begin{eqnarray}
  ...
  v_i, v_j, w_{k \nocomma l}) \nobracket +\mathcal{E}_3 (\lambda_0 ; v_i, v_k,
  w_{l \nocomma j}) \nonumber\\
...
\begin{equation}
  \label{eq20220216141706} 6 A_{i \nocomma j} \xi_2^j + E_{i \nocomma j
  \nocomma k \nocomma l}  \hspace{0.17em} \xi_1^j \xi_1^k \xi_1^l + 3
  \lambda_1 F_{i \nocomma j \nocomma k} \xi_1^j \xi_1^k + 3 \lambda_1^2 G_{i
  \nocomma j} \xi_1^j + 6 \lambda_2  \ring{E}_{i \nocomma j} \xi_1^j = 0,
\end{equation}
en posant \tmtextbf{C'est l'expression de $B_{ij}$ de Nick, voir {\'E}q.
(AC-5.14) p. 74}
\begin{equation}
  A_{i \nocomma j} = \xi_1^k \mathcal{E}_{i \nocomma j \nocomma k} (\lambda_0)
  + \lambda_1  \dot{\mathcal{E}}_{i \nocomma j} (\lambda_0)
\end{equation}
\tmtextbf{Cette expression co{\"i}ncide avec l'expression (AC-5.11), page 71,
de $\mathcal{E}_{i \nocomma j \nocomma k \nocomma l}$ de Nick. Le facteur 2
provient du fait que dans le probl{\`e}me variationnel (AC-5.9) qui
d{\'e}finit les $v_{i \nocomma j}$ de Nick, le facteur 2 du
probl{\`e}me~\eqref{eq20211221155859} n'est pas pr{\'e}sent.}
\begin{equation}
  E_{i \nocomma j \nocomma k \nocomma l} =\mathcal{E}_4  (\lambda_0 ; v_i,
  v_j, v_k, v_l) + 2 [\mathcal{E}_3 (\lambda_0 ; v_i, v_j, w_{k \nocomma l})
  +\mathcal{E}_3 (\lambda_0 ; v_i, v_k, w_{l \nocomma j}) +\mathcal{E}_3
  (\lambda_0 ; v_i, v_l, w_{j \nocomma k})] .
\end{equation}
\begin{equation}
  F_{i \nocomma j \nocomma k} = \dot{\mathcal{E}}_3  (\lambda_0 ; v_i, v_j,
  v_k) +\mathcal{E}_3  (\lambda_0 ; v_i, v_j, w_k) +\mathcal{E}_3  (\lambda_0
  ; v_i, w_j, v_k) + 2 \dot{\mathcal{E}_2} (\lambda_0 ; v_i, w_{j \nocomma k})
\end{equation}
\begin{equation}
  G_{i \nocomma j} = \ddot{\mathcal{E}}_{i \nocomma j} (\lambda_0) + 2
  \dot{\mathcal{E}_2} (v_i, w_j)
\end{equation}
On supposera satisfaite la condition suivante, qui assure que ce syst{\`e}me
est r{\'e}gulier
\begin{equation}
  \det (\xi_1^k \mathcal{E}_{i \nocomma j \nocomma k} + \lambda_1 
  \dot{\mathcal{E}}_{i \nocomma j}) \neq 0.
\end{equation}
...
\begin{eqnarray}
  ...
  &  & \nobracket + 3 \lambda_1  \dot{\mathcal{E}}_2 (\lambda_0 ; u_1, u_1)]
  ...
  &  & \nobracket + 6 \dot{\mathcal{E}}_2 (\lambda_0 ; u_1, u_2)] + 6
  \lambda_1^2  \ddot{\mathcal{E}}_2 (\lambda_0 ; u_1, u_1) \nonumber\\
  &  & \nobracket + 12 \lambda_2  \dot{\mathcal{E}}_2 (\lambda_0 ; u_1, u_1)
...
\begin{eqnarray}
  ...
  +\mathcal{E}_3 (\lambda_0 ; u_2, \hat{u}, \hat{u}) \nobracket + \lambda_2 
...
\begin{eqnarray}
  ...
  \partial_{\lambda \nocomma \lambda \nocomma \lambda}^3 F + 6 \lambda_2
  \partial_{\eta \nocomma \lambda}^2 F + 6 \lambda_1 \lambda_2
  \partial_{\lambda \nocomma \lambda}^2 F \nonumber\\
...
\begin{eqnarray}
  ...
  \nocomma \lambda \nocomma \lambda \nocomma \lambda}^4 F + 12 \lambda_2
  \partial_{\eta \nocomma \eta \nocomma \lambda}^3 F \nonumber\\
  &  & + 24 \lambda_1 \lambda_2 \partial_{\eta \nocomma \lambda \nocomma
  \lambda}^3 F + 12 \lambda_1^2 \lambda_2 \partial_{\lambda \nocomma \lambda
  \nocomma \lambda}^3 F + 24 \lambda_3 \partial_{\eta \nocomma \lambda}^2 F +
...
\begin{equation}
  \label{eq20211115082122} \mathcal{E}_{, u \nocomma u} [u (\eta), \lambda
...
\begin{equation}
  [\mathcal{E}_{i \nocomma j \nocomma k}  (\lambda_0) \xi_k + \lambda_1 
  \dot{\mathcal{E}}_{i \nocomma j} (\lambda_0)] \chi_j = \alpha_1 \chi_i,
\end{equation}
qui est un probl{\`e}me aux valeurs propres pour la matrice sym{\'e}trique
$[\mathcal{E}_{i \nocomma j \nocomma k}  (\lambda_0) \xi_k + \lambda_1 
\dot{\mathcal{E}}_{i \nocomma j} (\lambda_0)]_{1 \leq i, j \leq m}$.

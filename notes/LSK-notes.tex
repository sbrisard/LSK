...
\begin{equation}
  ...
  \E_{, u u} [u(η), \lambda(η); x, \hat{u}] = α \langle x, \hat{u} \rangle \quad \text{for all} \quad \hat{u} \in V,
\end{equation}
...
\begin{equation*}
  \begin{aligned}[b]
    ...
    & \order[0]α \langle \order[0]x, \hat{u} \rangle + η \bigl(\order[1]α \langle \order[0]x, \hat{u} \rangle + \order[0]α \langle \order[1]x, \hat{u} \rangle\bigr)\\
    & + \tfrac{1}{2} η^2 \bigl(\order[0]α \langle \order[2]x, \hat{u} \rangle + 2 \order[1]α \langle \order[1]x, \hat{u} \rangle + \order[2]α \langle \order[0]x, \hat{u} \rangle\bigr) + o(η^2).
  \end{aligned}
\end{equation*}
...
%   = 2\order[1]α \langle v_i,  \order[1]{χ_i}v_j + \order[0]{χ_j}\order[1]{ξ_k}w_{jk} + \order[1]\lambda \order[0]{χ_j} w_j \rangle
